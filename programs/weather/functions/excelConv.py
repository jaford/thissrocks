...
def excelConv(forcastDataList):
    ...
    for data in forcastDataList:
        ...
        if not os.path.exists(outputFile):
            ...
            print(f'The data for {dictName} has been saved to a new Excel file: {outputFile}\n')
        else:
            ...
            with pd.ExcelWriter(outputFile, mode='a', engine='openpyxl') as writer:
                ...
                print(f'The data for {dictName} has been saved to existing Excel file: {outputFile}\n')
